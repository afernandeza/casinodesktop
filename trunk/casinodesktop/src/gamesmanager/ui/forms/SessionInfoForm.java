...
public class SessionInfoForm extends JFrame implements ActionListener,
MouseListener {
    ...
    public SessionInfoForm(Client client) {
        ...
        if (o == pais) {
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>() {
                ...
                public Void doInBackground() {
                    int returnVal = fc.showOpenDialog(SessionInfoForm.this);
