...
public class LoginForm extends JPanel implements KeyListener, ActionListener{
	...
	public LoginForm(GUI mainwindow){
		...
		String[] labels = {"<html><b>Usuario:</b></html>", "<html><b>Contrase" + 
				Helpers.NTILDE + "a:</b></html>"};
        ...
        SpringUtilities.makeCompactGrid(loginform,
	...
	private void attemptLogin(){
		...
		boolean login = DatabaseOperations.login(username, password);
		if(login){
