...
public class SynchronizeDatabase extends Thread{
	...
	public void error(){
		JOptionPane.showMessageDialog(progress, "El servidor no est"+Helpers.AACUTE+" disponible.");
		progress.signalError();
	}
	
	public void success(){
		JOptionPane.showMessageDialog(progress, "Sincronizaci" +Helpers.OACUTE+"n exitosa");
